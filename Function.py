...
def pre_treatement(output_size = 1, test_dataset_size = 10000, TRAIN_SET_NUM = 10, SEQUENCE_SIZE = 20, Ts_train = 0.001, predict_sample_num = 1, batchsize = 1, fs_resample = 44.1):
